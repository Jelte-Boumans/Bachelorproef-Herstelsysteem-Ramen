...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(RX), wakeUp, CHANGE); // Attach interrupt to RX pin of AtMega, so when an incoming request is detected the AtMega will wake up
  ...
  //bme.setPressureOversampling(BME680_OS_4X);  // Uncomment if using pressure sensor
  bme.setIIRFilterSize(BME680_FILTER_SIZE_3);
  //bme.setGasHeater(320, 150); // 320°C for 150 ms  // Uncomment if using gas sensor
